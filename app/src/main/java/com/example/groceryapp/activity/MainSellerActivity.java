...
public class MainSellerActivity extends AppCompatActivity {
    ...
    private RelativeLayout productRl, ordersRl, toolbar1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar1 = findViewById(R.id.toolBarRl);

        progressBar.setVisibility(View.VISIBLE);
        toolbar1.setVisibility(View.GONE);
        productRl.setVisibility(View.GONE);
        searchProductEt.setVisibility(View.GONE);
        filterProductTv.setVisibility(View.GONE);
        filterProductBtn.setVisibility(View.GONE);
        ...
        logoutBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle("Confirm Sign Out").setMessage("Are you sure ?")
                        .setCancelable(false)
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot ds : dataSnapshot.getChildren()){
                            ...
                            filterProductTv.setVisibility(View.VISIBLE);
                            filterProductBtn.setVisibility(View.VISIBLE);
