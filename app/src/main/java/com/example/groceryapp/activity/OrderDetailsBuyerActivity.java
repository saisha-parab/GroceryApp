...
public class OrderDetailsBuyerActivity extends AppCompatActivity {
    ...
    private String orderFrom, orderId, deliveryFee, totalItems;

    private ImageButton backBtn, writeReviewBtn;
    private TextView orderIdTv, dateTv, orderStatusTv, shopNameTv, totalIemTv, amountTv, addressTv, paymentModeTv, deliveryTv, timingTv;
