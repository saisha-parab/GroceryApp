...
public class MainBuyerActivity extends AppCompatActivity {
    ...
    private ImageButton logoutBtn, editProfileBtn, cartBtn, settingsBtn;
    private RelativeLayout shopRl, ordersRl, toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settingsBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(MainBuyerActivity.this, SettingsActivity.class));
            }
        });
